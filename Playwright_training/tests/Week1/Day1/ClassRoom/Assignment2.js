// Assignment Details: 
// Declare a global variable and shadow it inside a function using both var and let to see how they behave differently 
// when printed. 
...
function getBrowserVersion(){
    let browserVersion = 120.5
    if(browserName== "Chrome"){
        console.log("Print the Broswser Version value from the if block - " + browserVersion)
    }
    console.log("Print the Browser value from the Function block - " + browserName)
    console.log("Print the Browser Version from the Function block - " + browserVersion)

} 
console.log("Print the Browser value from the Global is " + browserName)
getBrowserVersion()
